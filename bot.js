...
var%20color%20%3D%20new%20Discord.RichEmbed().setColor('%23000000').setColor('%2336393e')%0Afunction%20e(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setDescription(args)%0A%09.setFooter(%60By%20Request%20of%20%24%7Bmessage.author.username%7D%60)%3B%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%3B%0A%2F%2FErrors%20%5B%20function%20%5D%0Afunction%20err(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setAuthor(args%2C%20%22https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fcommons%2Fthumb%2F7%2F74%2FFeedbin-Icon-error.svg%2F1000px-Feedbin-Icon-error.svg.png%22)%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%3B%0A%2F%2FRequested%20by%20%5B%20function%20%5D%0Afunction%20ee(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setAuthor(args)%0A%09.setFooter(%60Requested%20by%20%24%7Bmessage.author.username%7D%60)%3B%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%3B%0A%2F%2FLeft%20the%20voice%20channel%20%5B%20function%20%5D%20%2C-%2C%0Afunction%20L(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setDescription(args)%0A%09.setFooter(%60By%20Request%20of%20%24%7Bmessage.author.username%7D%60)%3B%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%0A%2F%2FCurrent%20volume%20%5B%20function%20%5D%0Afunction%20V(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setAuthor(args%2C%20%22https%3A%2F%2Fwww.iconsdb.com%2Ficons%2Fpreview%2Fred%2Fvolume-up-4-xxl.png%22)%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%0A%2F%2F%20For%20the%20skip%20command%0Afunction%20S(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setDescription(args)%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%3B%0Afunction%20VS(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setDescription(args)%0A%09.setFooter(%22Requires%20Another%20Vote.%22)%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%3B%0Afunction%20Vs(message%2C%20args)%20%7B%0A%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09.setColor(color.color)%0A%09.setAuthor(args%2C%20%22https%3A%2F%2Fwww.iconsdb.com%2Ficons%2Fpreview%2Fred%2Fvolume-up-4-xxl.png%22)%0A%09message.channel.sendEmbed(embed)%3B%0A%7D%3B%0Aconst%20queue%20%3D%20new%20Map()%3B%0Avar%20regexp%20%3D%20%2F(ftp%7Chttp%7Chttps)%3A%5C%2F%5C%2F(%5Cw%2B%3A%7B0%2C1%7D%5Cw*%40)%3F(%5CS%2B)(%3A%5B0-9%5D%2B)%3F(%5C%2F%7C%5C%2F(%5B%5Cw%23!%3A.%3F%2B%3D%26%25%40!%5C-%5C%2F%5D))%3F%2F%0Aclient.on('message'%2C%20async%20message%20%3D%3E%20%7B%20%0A%09if%20(message.author.bot)%20return%20undefined%3B%0A%09if%20(!message.content.startsWith(prefix))%20return%20undefined%3B%0A%09const%20args%20%3D%20message.content.split('%20')%3B%0A%09const%20searchString%20%3D%20args.slice(1).join('%20')%3B%0A%09const%20voiceChannel%20%3D%20message.member.voiceChannel%3B%0A%09let%20command%20%3D%20message.content.toLowerCase().split('%20')%5B0%5D%3B%0A%09command%20%3D%20command.slice(prefix.length)%0A%09if%20(message.channel.type%20!%3D%3D%20'text')%20return%3B%0A%09const%20serverQueue%20%3D%20queue.get(message.guild.id)%3B%0A%09message.guild.setRegion(%22eu-central%22)%2F%2F%0A%09if%20(command%20%3D%3D%3D%20'play'%20%7C%7C%20command%20%3D%3D%3D%20'p'%20%7C%7C%20command%20%3D%3D%3D%20'search'%20%7C%7C%20command%20%3D%3D%3D%20%22ply%22)%20%7B%0A%09%09if%20(!voiceChannel)%20return%20err(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(message.guild.members.get(client.user.id).voiceChannel)%20%7B%0A%09%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%3B%0A%20%20%20%20%20%20%20%20%7D%3B%0A%09%09if%20(!args%5B1%5D)%20return%20err(message%2C%20%60You%20should%20To%20insert%20A%20song%20name%20or%20YouTube%20URL.%60)%0A%09%09const%20url%20%3D%20args%5B1%5D%20%3F%20args%5B1%5D.replace(%2F%3C(.%2B)%3E%2Fg%2C%20'%241')%20%3A%20''%3B%0A%09%09const%20validate%20%3D%20await%20ytdl.validateURL(args%5B1%5D)%3B%0A%09%09if%20(regexp.test(args%5B1%5D)%20%26%26%20!validate%20%26%26%20!url.match(%2F%5Ehttps%3F%3A%5C%2F%5C%2F(www.youtube.com%7Cyoutube.com)%5C%2Fplaylist(.*)%24%2F))%20return%20err(message%2C%20%60You%20should%20insert%20A%20valid%20URL.%60)%3B%0A%09%09if%20(url.match(%2F%5Ehttps%3F%3A%5C%2F%5C%2F(www.youtube.com%7Cyoutube.com)%5C%2Fplaylist(.*)%24%2F))%20%7B%0A%09%09%09const%20playlist%20%3D%20await%20youtube.getPlaylist(url)%3B%0A%20%20%20%20%20%20%20%20%20%20%20%20const%20videos%20%3D%20await%20playlist.getVideos()%3B%0A%09%09%09for%20(const%20video%20of%20Object.values(videos))%20%7B%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20const%20video2%20%3D%20await%20youtube.getVideoByID(video.id)%3B%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20await%20handleVideo(video2%2C%20message%2C%20voiceChannel%2C%20true)%3B%20%0A%20%20%20%20%20%20%20%20%20%20%20%20%7D%0A%09%09%09e(message%2C%60**%24%7Bplaylist.title%7D**%2C%20has%20been%20added%20to%20the%20queue%60)%0A%09%09%7Delse%20%7B%0A%09%09%09try%20%7B%0A%09%09%09%09var%20video%20%3D%20await%20youtube.getVideo(url)%3B%0A%09%09%09%7D%20catch%20(error)%20%7B%0A%09%09%09%09try%20%7B%0A%09%09%09%09%09var%20videos%20%3D%20await%20youtube.searchVideos(searchString%2C%2031)%3B%0A%09%09%09%09%09if%20(!videos%5B0%5D)%20return%20err(message%2C%20%60Cannot%20find%20Any%20Results.%60)%3B%0A%09%09%09%09%09var%20index%20%3D%200%3B%0A%09%09%09%09%09var%20pages%20%3D%201%3B%0A%09%09%09%09%09var%20msgg%20%3D%20%22%22%3B%0A%09%09%09%09%09var%20takoota%20%3D%20new%20Discord.RichEmbed()%0A%09%09%09%09%09.setAuthor(%22Search%20results..%22%2C%20'https%3A%2F%2Fcdn.discordapp.com%2Fattachments%2F480852478196187138%2F483165667877453834%2F20180826_094749.png')%0A%09%09%09%09%09.setColor(color.color)%0A%09%09%09%09%09.setThumbnail(%22https%3A%2F%2Fwww.denverlibrary.org%2Fsites%2Fdplorg%2Ffiles%2F2018%2F02%2Fyoutube-344105_640.png%22)%0A%09%09%09%09%09.setDescription(%60%24%7Bvideos.map(video2%20%3D%3E%20%60%24%7B%2B%2Bindex%7D.%20**%24%7Bvideo2.title%7D**%5Cn%60).slice(0%2C10).join('%5Cn')%7D%60)%0A%09%09%09%09%09.setFooter(%22Page%201%20of%203%22)%3B%0A%09%09%09%09%09message.channel.send(%7Bembed%20%3A%20takoota%7D).then(async%20msg1%20%3D%3E%20%7B%0A%09%09%09%09%09%09msgg%3Dmsg1.id%0A%09%09%09%09%09%09await%20msg1.react('%E2%97%80')%3B%0A%09%09%09%09%09%09await%20msg1.react('%E2%96%B6')%3B%0A%09%09%09%09%09%09let%20e%20%3D%20msg1.createReactionCollector((reaction%2C%20user)%20%3D%3E%20reaction.emoji.name%20%3D%3D%3D%20'%E2%97%80'%20%26%26%20user.id%20%3D%3D%3D%20message.author.id%2C%20%7B%20time%3A%2060000%20%7D)%3B%0A%09%09%09%09%09%09let%20t%20%3D%20msg1.createReactionCollector((reaction%2C%20user)%20%3D%3E%20reaction.emoji.name%20%3D%3D%3D%20'%E2%96%B6'%20%26%26%20user.id%20%3D%3D%3D%20message.author.id%2C%20%7B%20time%3A%2060000%20%7D)%3B%0A%09%09%09%09%09%09t.on(%22collect%22%2Casync%20()%20%3D%3E%20%7B%20%0A%09%09%09%09%09%09%09if%20(pages%20%3D%3D%201)%20%7B%0A%09%09%09%09%09%09%09%09pages%2B%3D1%0A%09%09%09%09%09%09%09index%20%3D%200%3B%0A%09%09%09%09%09%09%09var%20takoota%20%3D%20new%20Discord.RichEmbed()%0A%09%09%09%09%09%09%09.setAuthor(%22Search%20results..%22%2C%20'https%3A%2F%2Fcdn.discordapp.com%2Fattachments%2F480852478196187138%2F483165667877453834%2F20180826_094749.png')%0A%09%09%09%09%09%09%09.setColor(color.color)%20%0A%09%09%09%09%09%09%09.setThumbnail(%22https%3A%2F%2Fwww.denverlibrary.org%2Fsites%2Fdplorg%2Ffiles%2F2018%2F02%2Fyoutube-344105_640.png%22)%0A%09%09%09%09%09%09%09.setDescription(%60%24%7Bvideos.map(video2%20%3D%3E%20%60%24%7B%2B%2Bindex%7D.%20**%24%7Bvideo2.title%7D**%5Cn%60).slice(10%2C20).join('%5Cn')%7D%60)%0A%09%09%09%09%09%09%09.setFooter(%22Page%202%20of%203%22)%3B%0A%09%09%09%09%09%09%09msg1.edit(%7Bembed%20%3A%20takoota%7D)%3B%0A%09%09%09%09%09%09%09%7D%20else%20if%20(pages%20%3D%3D%202)%20%7B%0A%09%09%09%09%09%09%09%09pages%2B%3D1%0A%09%09%09%09%09%09%09%09var%20takoota%20%3D%20new%20Discord.RichEmbed()%0A%09%09%09%09%09%09%09.setAuthor(%22Search%20results..%22%2C%20'https%3A%2F%2Fcdn.discordapp.com%2Fattachments%2F480852478196187138%2F483165667877453834%2F20180826_094749.png')%0A%09%09%09%09%09%09%09.setColor(color.color)%20%0A%09%09%09%09%09%09%09.setThumbnail(%22https%3A%2F%2Fwww.denverlibrary.org%2Fsites%2Fdplorg%2Ffiles%2F2018%2F02%2Fyoutube-344105_640.png%22)%0A%09%09%09%09%09%09%09.setDescription(%60%24%7Bvideos.map(video2%20%3D%3E%20%60%24%7Bindex%2B%2B%20-%2030%7D.%20**%24%7Bvideo2.title%7D**%5Cn%60).slice(20%2C30.5).join('%5Cn')%7D%60)%0A%09%09%09%09%09%09%09.setFooter(%22Page%203%20of%203%22)%3B%0A%09%09%09%09%09%09%09msg1.edit(%7Bembed%20%3A%20takoota%7D)%3B%0A%09%09%09%09%09%09%09%7D%3B%0A%09%09%09%09%09%09%7D)%3B%0A%09%09%09%09%09%09e.on(%22collect%22%2C%20async%20()%20%3D%3E%20%7B%0A%09%09%09%09%09%09%09index%20%3D%200%3B%0A%09%09%09%09%09%09%09if%20(pages%20%3D%3D%202)%20%7B%0A%09%09%09%09%09%09%09%09pages-%3D1%0A%09%09%09%09%09%09%09var%20takoota%20%3D%20new%20Discord.RichEmbed()%0A%09%09%09%09%09%09%09.setAuthor(%22Search%20results..%22%2C%20'https%3A%2F%2Fcdn.discordapp.com%2Fattachments%2F480852478196187138%2F483165667877453834%2F20180826_094749.png')%0A%09%09%09%09%09%09%09.setColor(color.color)%0A%09%09%09%09%09%09%09.setThumbnail(%22https%3A%2F%2Fwww.denverlibrary.org%2Fsites%2Fdplorg%2Ffiles%2F2018%2F02%2Fyoutube-344105_640.png%22)%0A%09%09%09%09%09%09%09.setDescription(%60%24%7Bvideos.map(video2%20%3D%3E%20%60%24%7B%2B%2Bindex%7D.%20**%24%7Bvideo2.title%7D**%5Cn%60).slice(0%2C10).join('%5Cn')%7D%60)%0A%09%09%09%09%09%09%09.setFooter(%22Page%201%20of%203%22)%3B%0A%09%09%09%09%09%09%09msg1.edit(%7Bembed%20%3A%20takoota%7D)%0A%09%09%09%09%09%09%09%7D%20else%20if%20(pages%20%3D%3D%203)%20%7B%0A%09%09%09%09%09%09%09%09pages-%3D1%0A%09%09%09%09%09%09%09%09var%20takoota%20%3D%20new%20Discord.RichEmbed()%0A%09%09%09%09%09%09%09.setAuthor(%22Search%20results..%22%2C%20'https%3A%2F%2Fcdn.discordapp.com%2Fattachments%2F480852478196187138%2F483165667877453834%2F20180826_094749.png')%0A%09%09%09%09%09%09%09.setColor(color.color)%20%0A%09%09%09%09%09%09%09.setThumbnail(%22https%3A%2F%2Fwww.denverlibrary.org%2Fsites%2Fdplorg%2Ffiles%2F2018%2F02%2Fyoutube-344105_640.png%22)%0A%09%09%09%09%09%09%09.setDescription(%60%24%7Bvideos.map(video2%20%3D%3E%20%60%24%7B%2B%2Bindex%7D.%20**%24%7Bvideo2.title%7D**%5Cn%60).slice(10%2C20).join('%5Cn')%7D%60)%0A%09%09%09%09%09%09%09.setFooter(%22Page%202%20of%203%22)%3B%0A%09%09%09%09%09%09%09msg1.edit(%7Bembed%20%3A%20takoota%7D)%3B%0A%09%09%09%09%09%09%09%7D%0A%09%09%09%09%09%09%7D)%0A%09%09%09%09%09%09%0A%09%09%09%09%09%7D)%3B%0A%09%09%09%09%09try%20%7B%0A%09%09%09%09%09%09var%20response%20%3D%20await%20message.channel.awaitMessages(msg2%20%3D%3E%20msg2.content%20%3E%200%20%26%26%20msg2.content%20%3C%2031%20%26%26%20msg2.author.id%20%3D%3D%20message.author.id%2C%20%7B%0A%09%09%09%09%09%09%09maxMatches%3A%201%2C%0A%09%09%09%09%09%09%09time%3A%2060000%2C%0A%09%09%09%09%09%09%09errors%3A%20%5B'time'%5D%0A%09%09%09%09%09%09%7D)%3B%0A%09%09%09%09%09%7D%20catch%20(err)%20%7B%0A%09%09%09%09%09%09console.error(err)%3B%0A%09%09%09%09%09%09return%3B%0A%09%09%09%09%09%7D%0A%09%09%09%09%09response.first().delete()%3B%0A%09%09%09%09%09const%20videoIndex%20%3D%20parseInt(response.first().content)%3B%0A%09%09%09%09%09var%20video%20%3D%20await%20youtube.getVideoByID(videos%5BvideoIndex%20-%201%5D.id)%3B%0A%09%09%09%09%09var%20msg1%20%3D%20message.channel.messages.get(msgg)%3B%0A%09%09%09%09%09if%20(!msg1)%20return%3B%0A%09%09%09%09%09msg1.delete()%3B%0A%09%09%09%09%7D%20catch%20(err)%20%7B%0A%09%09%09%09%09console.error(err)%3B%0A%09%09%09%09%09return%3B%0A%09%09%09%09%7D%0A%09%09%09%7D%7D%0A%09%09%09%09const%20serverQueue%20%3D%20queue.get(message.guild.id)%3B%0A%09console.log(video)%3B%0A%09const%20song%20%3D%20%7B%0A%09%09id%3A%20video.id%2C%0A%09%09title%3A%20video.title%2C%0A%09%09url%3A%20%60https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D%24%7Bvideo.id%7D%60%0A%09%7D%3B%0A%09if%20(!serverQueue)%20%7B%0A%09%09const%20queueConstruct%20%3D%20%7B%0A%09%09%09textChannel%3A%20message.channel%2C%0A%09%09%09voiceChannel%3A%20voiceChannel%2C%0A%09%09%09connection%3A%20null%2C%0A%09%09%09songs%3A%20%5B%5D%2C%0A%09%09%09volume%3A%20100%2C%0A%09%09%09playing%3A%20true%2C%0A%09%09%09loop%20%3A%20false%2C%0A%09%09%09vote%20%3A%20%5B%5D%0A%09%09%7D%3B%0A%09%09queue.set(message.guild.id%2C%20queueConstruct)%3B%0A%0A%09%09queueConstruct.songs.push(song)%3B%0A%0A%09%09try%20%7B%0A%09%09%09var%20connection%20%3D%20await%20voiceChannel.join()%3B%0A%09%09%09queueConstruct.connection%20%3D%20connection%3B%0A%09%09%09play(message.guild%2C%20queueConstruct.songs%5B0%5D%2C%20message)%3B%0A%09%09%7D%20catch%20(error)%20%7B%0A%09%09%09console.error(%60%24%7Berror%7D%60)%3B%0A%09%09%09queue.delete(message.guild.id)%3B%0A%09%09%09return%3B%0A%09%09%7D%0A%09%7D%20else%20%7B%0A%09%09serverQueue.songs.push(song)%3B%0A%09%09console.log(serverQueue.songs)%3B%0A%09%09if%20(url.match(%2F%5Ehttps%3F%3A%5C%2F%5C%2F(www.youtube.com%7Cyoutube.com)%5C%2Fplaylist(.*)%24%2F))%20return%3B%0A%09%09await%20e(message%2C%20%60**%24%7Bsong.title%7D**%2C%20has%20been%20added%20to%20the%20queue%60)%0A%09%7D%3B%0A%09%0A%09return%20undefined%3B%0A%09async%20function%20handleVideo(video%2C%20message%2CvoiceChannel)%7B%0A%09%09%09%09%09%09const%20serverQueue%20%3D%20queue.get(message.guild.id)%3B%0A%09console.log(video)%3B%0A%09const%20song%20%3D%20%7B%0A%09%09id%3A%20video.id%2C%0A%09%09title%3A%20video.title%2C%0A%09%09url%3A%20%60https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3D%24%7Bvideo.id%7D%60%0A%09%7D%3B%0A%09if%20(!serverQueue)%20%7B%0A%09%09const%20queueConstruct%20%3D%20%7B%0A%09%09%09textChannel%3A%20message.channel%2C%0A%09%09%09voiceChannel%3A%20voiceChannel%2C%0A%09%09%09connection%3A%20null%2C%0A%09%09%09songs%3A%20%5B%5D%2C%0A%09%09%09volume%3A%20100%2C%0A%09%09%09playing%3A%20true%2C%0A%09%09%09loop%20%3A%20false%0A%09%09%7D%3B%0A%09%09queue.set(message.guild.id%2C%20queueConstruct)%3B%0A%0A%09%09queueConstruct.songs.push(song)%3B%0A%0A%09%09try%20%7B%0A%09%09%09var%20connection%20%3D%20await%20voiceChannel.join()%3B%0A%09%09%09queueConstruct.connection%20%3D%20connection%3B%0A%09%09%09play(message.guild%2C%20queueConstruct.songs%5B0%5D%2C%20message)%3B%0A%09%09%7D%20catch%20(error)%20%7B%0A%09%09%09console.error(%60%24%7Berror%7D%60)%3B%0A%09%09%09queue.delete(message.guild.id)%3B%0A%09%09%09return%3B%0A%09%09%7D%0A%09%7D%20else%20%7B%0A%09%09serverQueue.songs.push(song)%3B%0A%09%09console.log(serverQueue.songs)%3B%0A%09%09if%20(url.match(%2F%5Ehttps%3F%3A%5C%2F%5C%2F(www.youtube.com%7Cyoutube.com)%5C%2Fplaylist(.*)%24%2F))%20return%3B%0A%09%09await%20e(message%2C%20%60**%24%7Bsong.title%7D**%2C%20has%20been%20added%20to%20the%20queue%60)%0A%09%7D%3B%0A%09return%20undefined%3B%0A%09%7D%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'skip'%20%7C%7C%20command%20%3D%3D%3D%20's'%20%7C%7C%20command%20%3D%3D%3D%20'ski'%20%7C%7C%20command%20%3D%3D%3D%20'sk')%20%7B%0A%09%09if%20(!message.member.voiceChannel)%20return%20err(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%3B%0A%09%09if%20(!serverQueue)%20return%20err(message%2C%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(serverQueue.songs.length%20%3D%3D%201)%20return%20err(message%2C%20%22Only%201%20song%20is%20Queued.%22)%0A%09%09if%20(serverQueue.vote.includes(message.author.id))%20return%20err(message%2C%20%60You%20Already%20Voted%20To%20skip.%60)%3B%0A%09%09serverQueue.vote.push(message.author.id)%0A%09%09var%20allusers%20%3D%20message.guild.members.filter(m%20%3D%3E%20m.voiceChannel).size%3B%0A%09%09var%20required%20%3D%20allusers%2F2%0A%09%09if%20(required%3C%3DserverQueue.vote.length)%20%7B%0A%09%09%09if%20(serverQueue.loop%20%3D%3D%20true)await%20serverQueue.songs.shift()%3B%0A%09%09%09await%20serverQueue.connection.dispatcher.end('Skip%20command%20has%20been%20used!')%3B%0A%09%09%09await%20S(message%2C%20%60**%24%7BserverQueue.songs%5B0%5D.title%7D**%2C%20has%20been%20skipped%60)%3B%0A%09%09%7D%20else%20%7B%0A%09%09%09VS(message%2C%20%60**%24%7Bmessage.author.username%7D**%2C%20has%20been%20voted%20to%20skip%60)%0A%09%09%7D%0A%09%09return%20undefined%3B%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'stop'%20%7C%7C%20command%20%3D%3D%3D%20'st'%20%7C%7C%20command%20%3D%3D%3D%20'sto')%20%7B%0A%09if%20(!serverQueue)%20return%20err(message%2C%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%0A%09if%20(!message.member.voiceChannel)%20return%20err(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20use%20This%20Command.%60)%3B%09%09%0A%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%0A%09%09e(message%2C%20%60Okey%2C%20Music%20has%20been%20stopped%60)%3B%0A%09%09serverQueue.songs%20%3D%20%5B%5D%3B%0A%09%09serverQueue.connection.dispatcher.end('Stop%20command%20has%20been%20used!')%3B%0A%09%09return%20undefined%3B%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20%22leave%22%20%7C%7C%20command%20%3D%3D%3D%20'disconnect'%20%7C%7C%20command%20%3D%3D%3D%20'l')%20%7B%0A%09%09if%20(!message.guild.members.get(client.user.id).voiceChannel)%20return%3B%0A%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%3B%0A%09%09if%20(serverQueue)%20serverQueue.songs%20%3D%20%5B%5D%3B%0A%09%09if%20(serverQueue)%20serverQueue.connection.dispatcher.end('leave%20command%20has%20been%20used!')%3B%0A%09%09message.member.voiceChannel.join()%3B%0A%09%09message.member.voiceChannel.leave()%3B%0A%09%09L(message%2C%20%60%3Adoor%3A%20I%20have%20disconnected%20from%20%24%7Bmessage.guild.members.get(client.user.id).voiceChannel.name%7D%60)%3B%0A%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'volume'%20%7C%7C%20command%20%3D%3D%3D%20'vol'%20%7C%7C%20command%20%3D%3D%3D%20'v')%20%7B%0A%09%09if%20(!serverQueue)%20return%20err(message%2C%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(!message.member.voiceChannel)%20return%20err(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%0A%09%09if%20(!args%5B1%5D)%20return%20V(message%2C%60The%20current%20volume%20is%20%24%7BserverQueue.volume%7D%25%60)%3B%0A%09%09args%5B1%5D%20%3D%20parseInt(args%5B1%5D)%3B%0A%09%09if%20(args%5B1%5D%20%3E%20200%20%7C%7C%20args%5B1%5D%3C2)%20return%20err(message%2C%20%60Only%20allowed%20from%202%20-%20200%60)%0A%09%09if%20(isNaN(args%5B1%5D))%20return%20err(message%2C%20%60Only%20numbers%20are%20allowed.%60)%0A%09%09if%20(args%5B1%5D%20%3D%3D%20serverQueue.volume)%20return%20err(message%2C%20%60My%20Volume%20is%20already%20%24%7BserverQueue.volume%7D%25%60)%0A%09%09serverQueue.volume%20%3D%20args%5B1%5D%3B%0A%09%09serverQueue.connection.dispatcher.setVolumeLogarithmic(args%5B1%5D%20%2F%20250)%3B%0A%09%09return%20Vs(message%2C%20%60Volume%20Successfully%20Changed%20to%20%24%7Bargs%5B1%5D%7D%25%60)%3B%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'queue'%20%7C%7C%20command%20%3D%3D%3D%20'q'%20%7C%7C%20command%20%3D%3D%3D%20%22qu%22%20%7C%7C%20command%20%3D%3D%3D%20'que')%20%7B%0A%09%09if%20(!serverQueue)%20return%20err(message%2C%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%09%09else%20if%20(!message.member.voiceChannel)%20return%20err(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09else%20if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%0A%09%09else%20%7B%0A%09%09var%20y%20%3D%200%3B%0A%09%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09%09embed.setColor(color.color)%3B%0A%09%09embed.setAuthor(%60Now%20playing%20%F0%9F%8E%B6%20%24%7BserverQueue.songs%5B0%5D.title%7D%60)%0A%09%09embed.setURL(serverQueue.songs%5B0%5D.url)%0A%20%20%20%20%20%20%20%20if%20(serverQueue.songs.length%20%3C%3D1)%20return%20message.channel.send(%7Bembed%20%3Aembed%7D)%3B%0A%20%20%20%20%20%20%20%20var%20str%20%3D%20%60%24%7BserverQueue.songs.map(song%20%3D%3E%20%60%24%7By%2B%2B%7D.%20%5B%24%7Bsong.title%7D%5D(%24%7Bsong.url%7D)%5Cn%60).slice(1%2C11).join(%22%5Cn%22)%7D%5Cn%5Cn%60%3B%0A%20%20%20%20%20%20%20%20var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%20%20%20%20%20%20%20%20.setColor(color.color)%0A%20%20%20%20%20%20%20%20.setAuthor(message.guild.name%2C%20message.guild.iconURL)%0A%20%20%20%20%20%20%20%20.setThumbnail(%22https%3A%2F%2Fmedia.discordapp.net%2Fattachments%2F492975144147615744%2F493028296699936777%2F1537617500423.png%22)%0A%20%20%20%20%20%20%20%20.setDescription(str)%3B%0A%20%20%20%20%20%20%20%20if%20((serverQueue.songs.length-10)%20%3E%200)%20embed.setFooter(%60And%20%24%7BserverQueue.songs.length-10%7D%20More..%60)%3B%0A%20%20%20%20%20%20%20%20message.channel.send(%7Bembed%20%3A%20embed%7D)%3B%0A%09%09%7D%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'pause'%20%7C%7C%20command%20%3D%3D%3D%20'pa'%20%7C%7C%20command%20%3D%3D%3D%20'pau'%20%7C%7C%20command%20%3D%3D%3D%20'paus')%20%7B%0A%09%09if%20(!serverQueue)%20return%20err(message%2C%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(serverQueue%20%26%26%20serverQueue.playing)%20%7B%0A%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%0A%09%09if%20(!message.member.voiceChannel)%20return%20ee(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09%09serverQueue.playing%20%3D%20false%3B%0A%09%09%09serverQueue.connection.dispatcher.pause()%3B%0A%09%09%09e(message%2C%20%60**%24%7BserverQueue.songs%5B0%5D.title%7D**%2C%20has%20been%20paused%60)%3B%0A%09%09%09return%3B%0A%09%09%7D%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'resume'%20%7C%7C%20command%20%3D%3D%3D%20'r'%20%7C%7C%20command%20%3D%3D%3D%20'continue'%20%7C%7C%20command%20%3D%3D%3D%20%22res%22)%20%7B%0A%09%09if%20(!serverQueue)%20return%20err(message%2C%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(serverQueue%20%26%26%20!serverQueue.playing)%20%7B%0A%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%0A%09%09if%20(!message.member.voiceChannel)%20return%20err(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09%09serverQueue.playing%20%3D%20true%3B%0A%09%09%09serverQueue.connection.dispatcher.resume()%3B%0A%09%09%09e(message%2C%20%60**%24%7BserverQueue.songs%5B0%5D.title%7D**%2C%20has%20been%20resumed%60)%3B%0A%09%09%09return%3B%0A%09%7D%3B%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'repeat'%20%7C%7C%20command%20%3D%3D%3D%20'rpt')%20%7B%0A%09%09if%20(!serverQueue)%20return%20err(message%2C%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%09%09if%20(serverQueue)%20%7B%0A%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%0A%09%09if%20(!message.member.voiceChannel)%20return%20ee(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09%09serverQueue.songs.splice(1%2C%200%2C%20serverQueue.songs%5B0%5D)%0A%09%09%09e(message%2C%20%60**%24%7BserverQueue.songs%5B0%5D.title%7D**%2C%20Will%20be%20repeated%60)%3B%0A%09%09%09return%20undefined%3B%0A%09%09%7D%0A%09%7D%20else%20if%20(command%20%3D%3D%3D%20'loop'%20%7C%7C%20command%20%3D%3D%3D%20'lo')%20%7B%0A%09%09%09if%20(!serverQueue)%20return%20err(message%2C%20%60You%20Should%20Play%20Something%20To%20Use%20This%20Command.%60)%3B%0A%09%09%09if%20(serverQueue%20%26%26%20serverQueue.playing)%20%7B%0A%09%09%09%09if%20(!message.member.voiceChannel)%20return%20err(message%2C%60You%20Should%20Be%20in%20A%20Voice%20Channel%20To%20Use%20This%20Command.%60)%3B%0A%09%09%09%09if%20(message.guild.members.get(message.member.id).voiceChannel.id%20!%3D%3D%20message.guild.members.get(client.user.id).voiceChannel.id)%20return%20err(message%20%2C%20%60You%20Should%20Be%20in%20My%20Voice%20Channel%20To%20Use%20My%20Commands.%60)%0A%09%09%09%09if%20(serverQueue.loop%20%3D%3D%20false)%20%7B%0A%09%09%09%09%09serverQueue.loop%20%3D%20true%3B%0A%09%09%09%09%09e(message%2C%20%60**%24%7BserverQueue.songs%5B0%5D.title%7D**%2C%20will%20be%20looped%60)%0A%09%09%09%09%7D%20else%20if%20(serverQueue.loop%20%3D%3D%20true)%20%7B%0A%09%09%09%09%09serverQueue.loop%20%3D%20false%3B%0A%09%09%09%09%09e(message%2C%20%60**%24%7BserverQueue.songs%5B0%5D.title%7D**%2C%20will%20not%20be%20looped%20again%60)%0A%09%09%09%09%7D%3B%0A%09%09%09%7D%0A%09%09%7D%0A%7D)%3B%0A%0A%0Afunction%20play(guild%2C%20song%2C%20message)%20%7B%0A%09setTimeout(function()%7B%0A%09%09const%20serverQueue%20%3D%20queue.get(guild.id)%3B%0A%09%09if%20(!song)%20%7B%0A%09%09%09serverQueue.voiceChannel.leave()%3B%0A%09%09%09serverQueue.voiceChannel.join()%3B%0A%09%09%09queue.delete(guild.id)%3B%0A%09%09%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09%09%09embed.setColor(color.color)%0A%09%09%09embed.setDescription(%60%3Acheckered_flag%3A%20**%24%7Bmessage.guild.name%7D**%20Queue%20has%20been%20finished.%60)%0A%09%09%09serverQueue.textChannel.send(embed)%0A%09%09%09return%3B%0A%09%09%7D%3B%0A%09%09if%20(!serverQueue.songs%5B0%5D)%7B%0A%09%09%09serverQueue.voiceChannel.leave()%3B%0A%09%09%09serverQueue.voiceChannel.join()%3B%0A%09%09%09queue.delete(guild.id)%3B%0A%09%09%09return%3B%0A%09%09%7D%3B%0A%09%09console.log(serverQueue.songs)%3B%0A%09%09serverQueue.vote%20%3D%20%5B%5D%3B%0A%09%09const%20dispatcher%20%3D%20serverQueue.connection.playStream(ytdl(song.url))%0A%09%09.on('end'%2C%20reason%20%3D%3E%20%7B%0A%09%09%09if%20(reason%20%3D%3D%3D%20'Stream%20is%20not%20generating%20quickly%20enough.')%20console.log('Song%20ended.')%3B%0A%09%09%09else%20console.log(reason)%3B%0A%09%09%09if%20(serverQueue.loop%20%3D%3D%20true)%20%7B%0A%09%09%09%09play(guild%2C%20serverQueue.songs%5B0%5D%2C%20message)%3B%0A%09%09%09%09return%20undefined%3B%0A%09%09%09%7D%3B%0A%09%09%09serverQueue.songs.shift()%3B%0A%09%09%09play(guild%2C%20serverQueue.songs%5B0%5D%2C%20message)%3B%0A%09%09%7D)%0A%09%09.on('error'%2C%20error%20%3D%3E%20console.error(error))%3B%0A%09%09dispatcher.setVolumeLogarithmic(serverQueue.volume%20%2F%20250)%3B%0A%09%09var%20embed%20%3D%20new%20Discord.RichEmbed()%0A%09%09embed.setColor(color.color)%3B%0A%09%09embed.setAuthor(%60Now%20playing%20%F0%9F%8E%B6%20%24%7BserverQueue.songs%5B0%5D.title%7D%60)%0A%09%09embed.setURL(serverQueue.songs%5B0%5D.url)%0A%09%09serverQueue.textChannel.send(embed)%0A%09%7D%2C10)%3B%0A%7D
...
client.on('message', async message => {
 ...
 if (message.content === '$help') {
 message.author.send(`ّ`).catch(RebeL =>{console.log('`Error`: ' + RebeL);
